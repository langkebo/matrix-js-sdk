...
import { TAGS_ROUTES_STATUS_SCENARIOS, TAGS_ROUTES_ERROR_SCENARIOS, TAGS_ROUTES_ERRCODES } from "./contract-assertions";

describe("tags contract acceptance", () => {
    let mockClient: any;
