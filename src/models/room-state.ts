...
import { removeHiddenChars } from "../common/strings";
...
import { type RoomJoinRulesEventContent } from "../@types/state_events";
import { shouldUseHydraForRoomVersion } from "../utils/roomVersion";
import { Beacon, BeaconEvent, getBeaconInfoIdentifier, type BeaconIdentifier } from "./beacon";
