...
const sdkFiles = ["src/account-data/index.ts", "src/client-account-data-requests.ts", "spec/unit/account-data.spec.ts"];
...
const endpoints = [
    ...
    {
        name: "DELETE /user/{user_id}/account_data/{type}",
        pattern: /DELETE.*\/user\/\{user_id\}\/account_data\/\{type\}/,
    },
    {
        name: "GET /user/{user_id}/rooms/{room_id}/account_data/{type}",
        pattern: /GET.*\/user\/\{user_id\}\/rooms\/\{room_id\}\/account_data\/\{type\}/,
    },
    {
        name: "PUT /user/{user_id}/rooms/{room_id}/account_data/{type}",
        pattern: /PUT.*\/user\/\{user_id\}\/rooms\/\{room_id\}\/account_data\/\{type\}/,
    },
    {
        name: "DELETE /user/{user_id}/rooms/{room_id}/account_data/{type}",
        pattern: /DELETE.*\/user\/\{user_id\}\/rooms\/\{room_id\}\/account_data\/\{type\}/,
    },
];
...
const errorCodes = ["M_FORBIDDEN", "M_NOT_FOUND", "M_BAD_JSON", "M_INVALID_PARAM", "M_TOO_LARGE", "M_UNKNOWN"];
...
const tables = ["account_data", "room_account_data", "filters", "openid_tokens"];
